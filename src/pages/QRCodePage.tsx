...
const PROPS_DOC = [
  {
    ...
    type: "string",
    default: "—",
    description: "Nội dung cần mã hoá (URL, text, ...)",
  },
  {
    prop: "size",
    type: "'sm' | 'md' | 'lg' | 'xl'",
    default: "'md'",
    description: "Preset kích thước: 96 / 128 / 192 / 256px",
  },
  {
    prop: "pixelSize",
    type: "number",
    default: "—",
    description: "Ghi đè kích thước pixel (ưu tiên hơn size)",
  },
  {
    prop: "level",
    type: "'L' | 'M' | 'Q' | 'H'",
    default: "'L'",
    description: "Mức độ sửa lỗi — L thấp, H cao (dùng H khi có logo)",
  },
  {
    prop: "bgColor",
    type: "string",
    default: "'#ffffff'",
    description: "Màu nền (hex hoặc rgb)",
  },
  {
    prop: "fgColor",
    type: "string",
    default: "'#000000'",
    description: "Màu module QR (hex hoặc rgb)",
  },
  {
    prop: "marginSize",
    type: "number",
    default: "2",
    description: "Số module khoảng trắng xung quanh QR",
  },
  {
    prop: "imageSettings",
    type: "QRCodeImageSettings",
    default: "—",
    description: "Logo/ảnh nhúng vào giữa — khuyên dùng kèm level H",
  },
  {
    prop: "renderer",
    type: "'svg' | 'canvas'",
    default: "'svg'",
    description: "SVG: sắc nét mọi kích thước; Canvas: download PNG",
  },
  {
    prop: "title",
    type: "string",
    default: "auto",
    description: "Tiêu đề accessibility cho screen reader",
  },
  {
    prop: "label",
    type: "string",
    default: "—",
    description: "Nhãn hiển thị phía trên QR code",
  },
  {
    prop: "description",
    type: "string",
    default: "—",
    description: "Chú thích hiển thị phía dưới QR code",
  },
  {
    prop: "downloadable",
    type: "boolean",
    default: "false",
    description: "Hiển thị nút tải xuống (SVG hoặc PNG)",
  },
  {
    prop: "downloadFilename",
    type: "string",
    default: "'qrcode'",
    description: "Tên file khi tải (không có đuôi mở rộng)",
  },
  {
    prop: "className",
    type: "string",
    default: "—",
    description: "Class tuỳ chỉnh cho container ngoài cùng",
  },
] as const;
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="bg-muted/30">
            <tr>
              <th className="text-left px-6 py-3 font-medium text-foreground">
                Prop
              </th>
              <th className="text-left px-6 py-3 font-medium text-foreground">
                Type
...
<QRCode value="https://example.com" />`}</pre>
        ...
        <div>
          <p className="font-medium text-foreground mb-1">
            2. Tuỳ chỉnh kích thước & màu sắc
          </p>
