...
const PopoverPage = () => (
    <div className="max-w-4xl">
        ...
        <ShowcaseCard title="Basic Popover">
            <Popover>
                <PopoverTrigger><Button variant="outline"><Settings className="w-4 h-4 mr-2" />Cài đặt</Button></PopoverTrigger>
                <PopoverContent>
            ...
            <Popover>
                <PopoverTrigger><Button variant="secondary"><Bell className="w-4 h-4 mr-2" />Thông báo <Badge size="sm" variant="danger" className="ml-1">3</Badge></Button></PopoverTrigger>
                <PopoverContent>
